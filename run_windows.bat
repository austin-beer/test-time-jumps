    ...
    powershell "./test_time_jumps_austin_no_generic_shared.exe  | tee windows_results_austin_no_generic_shared.txt"
    powershell "./test_time_jumps_austin_yes_generic_shared.exe | tee windows_results_austin_yes_generic_shared.txt"
    net start w32time
